        ...
        <nav className="hidden md:flex md:gap-4 lg:gap-12 items-center text-white/90 font-medium">
          ...
          <div className="group relative">
            ...
            {/* Desktop Dropdown Menu */}
              <div className="transition-all max-w-7xl absolute hidden group-hover:block top-full -right-20  w-[80vw] bg-neutral-900 pt-7 shadow-lg py-4 z-50 rounded-xl h-96 mx-auto">
