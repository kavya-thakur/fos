  ...
  return (
    <section className="bg-gradient-to-b from-white to-[#d2DCFF] py-24">
      <div className="container mx-auto px-4">
        ...
        <h2 className="text-center font-bold text-3xl md:text-4xl lg:text-6xl tracking-tighter bg-gradient-to-b from-black to-[#001E80] text-transparent bg-clip-text capitalize ">A more effective way to track progress</h2>
