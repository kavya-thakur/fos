    ...
    <>
      ...
      <section className="relative  bg-black py-24 lg:py-[13vw]">
        ...
        <div className="z-10  inset-0 flex items-center justify-center flex-col absolute container mx-auto px-4 gap-4 md:gap-10">
          ...
          <h2 className="text-center font-bold text-3xl md:text-4xl lg:text-7xl tracking-tighter bg-gradient-to-r from-neutral-300 to-stone-400 text-transparent bg-clip-text capitalize font-['Aboreto']">
